...
data_path="/Users/kritibbhattarai/Desktop/Treatment_optimization_AD/revision/codes/hyper-ad-dep/data/main-experiment/"

data1= pd.read_csv(data_path+'ad_dep_hyp_data_with_states.csv', low_memory=False)
...
print("ad_dep_hyp_weighted_group=",weighted_group.tolist())
