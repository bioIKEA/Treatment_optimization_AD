...
data_path="/Users/kritibbhattarai/Desktop/Treatment_optimization_AD/revision/codes/ad-only/data/main-experiment/"

data1= pd.read_csv(data_path+'ad_data_with_states.csv', low_memory=False)
...
plt.savefig('5000repsmaincolored_full_main.png')
# show plot
plt.show()
