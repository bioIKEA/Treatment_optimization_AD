...
data_path="/Users/kritibbhattarai/Desktop/Treatment_optimization_AD/revision/codes/depression-ad/data/main-experiment/"

data1= pd.read_csv(data_path+'ad_depression_with_states.csv', low_memory=False)
...
print("ad_depression_weighted_group=", weighted_group.tolist())
