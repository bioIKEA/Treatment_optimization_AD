...
merged_file= pd.read_csv("/Users/kritibbhattarai/Desktop/Treatment_optimization_AD/revision/codes/depression-ad/data/main-experiment/ad_depression_data.csv")
...
for index,row in merged_file.iterrows():
    if ( row['ADAS13_pre'] <= 26.164999961853027 ) :
...
merged_data25.to_csv('ad_depression_with_states.csv', index = False)  # Export merged pandas DataFrame
