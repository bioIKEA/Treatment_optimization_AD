...
medication_file.replace('-4', np.nan, inplace=True)
medication_file.replace(2, np.nan,inplace=True)
medication_file.replace(3, np.nan,inplace=True)
medication_file.replace('2', np.nan, inplace=True)
medication_file.replace('3', np.nan, inplace=True)
medication_file.replace(1, np.nan,inplace=True)
medication_file.replace('1', np.nan, inplace=True)
...
merged_data.to_csv('whole-data-without-states.csv', index = False)  # Export merged pandas DataFrame
