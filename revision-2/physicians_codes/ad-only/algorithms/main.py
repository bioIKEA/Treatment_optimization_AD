...
data_path="/Users/kritibbhattarai/Desktop/Treatment_optimization_AD/physicians_codes/ad-only/data/main/"

data1= pd.read_csv(data_path+'merged_finalMMSE.csv', low_memory=False)
...
###################################################################################plotting################################################################
print("main= ",weighted_group)
print("main_list= ",weighted_group.tolist())
