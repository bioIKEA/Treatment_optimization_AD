...
data_path="/Users/kritibbhattarai/Desktop/internship/Alzheimer's/python/new-w-bootstrap/whole-data-states/data/"

data1= pd.read_csv(data_path+'merged_final_12_states.csv', low_memory=False)
...
plt.savefig('12_states_reward.png')
# show plot
plt.show()
