...
data_path="/Users/kritibbhattarai/Desktop/internship/Alzheimer's/python/new-w-bootstrap/ad-only-states/data/"

data1= pd.read_csv(data_path+'merged_finalMMSE_5_states.csv', low_memory=False)
...
print("5_ad_only: ", weighted_group)
...
plt.savefig('5_states_reward.png')
# show plot
plt.show()
