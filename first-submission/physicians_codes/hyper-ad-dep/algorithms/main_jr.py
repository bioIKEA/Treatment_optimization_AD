...
data_path="/Users/kritibbhattarai/Desktop/Treatment_optimization_AD/physicians_codes/hyper-ad-dep/data/jr/"

data1= pd.read_csv(data_path+'jr_final.csv', low_memory=False)
...
###################################################################################plotting################################################################
print("jr_phy= ",weighted_group)
print("jr_phy_list= ",weighted_group.tolist())
