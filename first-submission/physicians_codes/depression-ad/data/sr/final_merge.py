...
merged_file= pd.read_csv("/Users/kritibbhattarai/Desktop/Treatment_optimization_AD/physicians_codes/depression-ad/data/sr/sr_phy_wo_sa.csv")
...
for index,row in merged_file.iterrows():
    if ( row['CDRSB_pre'] <= 3.75 ) :
        if ( row['ADAS13_pre'] <= 17.164999961853027 ) :
            state=0
