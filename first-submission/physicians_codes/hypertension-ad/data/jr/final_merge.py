...
merged_file= pd.read_csv("/Users/kritibbhattarai/Desktop/Treatment_optimization_AD/physicians_codes/hypertension-ad/data/jr/jr_phy_wo_sa.csv")
    ...
    if ( row['ADAS13_pre'] <= 28.5 ) :
        if ( row['ADAS13_pre'] <= 22.835000038146973 ) :
            ...
            if ( row['RAVLT.immediate_pre'] <= 27.5 ) :
                if ( row['FDG_pre'] <= 4.392131090164185 ) :
                    state=3
