...
data_path='/Users/kritibbhattarai/Desktop/Treatment_optimization_AD/adni+aibl/algorithm/with-ad/data/adni-data/data-processing/'

merged_file= pd.read_csv("processed_adni_with_ad_lab_file.csv")
...
merged_data25.to_csv('adni_with_ad_lab_w_states.csv', index = False)  # Export merged pandas DataFrame
