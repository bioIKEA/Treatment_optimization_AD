...
train_data_path='/Users/kritibbhattarai/Desktop/Treatment_optimization_AD/adni+aibl/algorithm/with-ad/data/adni-data/data-processing/'


test_data_path='/Users/kritibbhattarai/Desktop/Treatment_optimization_AD/adni+aibl/algorithm/with-ad/data/aibl-data/data-processing/'

data= pd.read_csv(train_data_path+'adni_with_ad_lab_w_states.csv', low_memory=False)
