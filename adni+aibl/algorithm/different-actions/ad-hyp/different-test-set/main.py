...
train_data_path='/Users/kritibbhattarai/Desktop/Treatment_optimization_AD/adni+aibl/algorithm/ad-hyp/data/adni-data/data-processing/'


test_data_path='/Users/kritibbhattarai/Desktop/Treatment_optimization_AD/adni+aibl/algorithm/ad-hyp/data/aibl-data/data-processing/'

data= pd.read_csv(train_data_path+'adni_ad_hyp_lab_w_states.csv', low_memory=False)
