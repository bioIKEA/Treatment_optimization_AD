...
data_path='/Users/kritibbhattarai/Desktop/Treatment_optimization_AD/adni+aibl/adni-data/data-processing/'
merged_file= pd.read_csv("processed_adni_lab_file.csv")
...
merged_data25.to_csv('adni_lab_w_states.csv', index = False)  # Export merged pandas DataFrame
